google.maps.__gjsload__('search', function(_) {
    ...
    var Dva = {
        ...
        Bva = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.xs(new _.zr((this.Hn.x * 256 + this.source.a[0]) / a, (this.Hn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
    ...
    TH.enableFeatureMapEventsRasterOnly = TH.enableFeatureMapEventsRasterOnly;
    _.qo(TH.prototype, {
        map: _.Lt
    });
