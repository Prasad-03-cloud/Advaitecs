google.maps.__gjsload__('overlay', function(_) {
    var Yya = function() {},
        ...
        gza = function(a) {
            if (a) {
                var b = a.getMap();
                if (cza(a) !== b && b && b instanceof _.co) {
                    const c = b.__gm;
                    c.overlayLayer ? a.__gmop = new dza(b, a, c.overlayLayer) : c.Eg.then(({
                        ah: d
                    }) => {
                        const e = new eza(b, d);
                        d.Qi(e);
        ...
        fza = function(a) {
            if (a) {
                ...
                b && (a.__gmop = null, b.overlay.unbindAll(), b.overlay.set("panes",
                    null), b.overlay.set("projection", null), b.overlayLayer.so(b), b.Dg && (b.Dg = !1, b.overlay.onRemove ? b.overlay.onRemove() : b.overlay.remove()))
            }
        },
        cza = function(a) {
    ...
    var dza = class {
        ...
        eza = class {
            ...
            dispose() {}
            zh(a, b, c, d, e, f, g, h) {
                const k = this.Dg = this.Dg || new _.hC(this.map, this.ah, () => {});
                k.zh(a, b, c, d, e, f, g, h);
                for (const m of this.Eg) hza(m, k), m.draw()
            }
            Ln(a) {
                this.Eg.push(a);
                this.Dg &&
    ...
    _.Il("overlay", {
        RD: function(a) {
            if (a) {
                ...
                fza(a);
                var b = a.getMap();
                b && (b instanceof _.co ? gza(a) : a && (b = a.getMap(), (DI(a).Hg || null) !== b && (b && aza(a, b), DI(a).Hg = b)))
            }
        },
